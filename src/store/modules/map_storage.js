...
const actions =
{
    ...
    initMapAction: ({commit,rootState,state,dispatch,}) =>
    {
        ...
        let credctrl = L.controlCredits({
            ...
            text: "<div>Bloody Stupid Johnson<a href=\"http://www.freepik.com\" title=\"Freepik\">Freepik</a> from <a href=\"https://www.flaticon.com/\" title=\"Flaticon\">www.flaticon.com</a> <a href=\"http://creativecommons.org/licenses/by/3.0/\" title=\"Creative Commons BY 3.0\" target=\"_blank\">CC 3.0 BY</a></div>"
        }).addTo(map);
